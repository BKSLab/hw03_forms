...
class PostPagesTests(TestCase):
    ...
    def test_create_post_correct_context(self):
        """В шаблон create_post.html передается правильный контекст при созздании поста"""
    ...
    def test_edit_post_correct_context(self):
        """В шаблон create_post.html передается правильный контекст при редактирование поста"""
